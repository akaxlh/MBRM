...
def parse_args():
	...
	parser.add_argument('--mult', default=1, type=float, help='mult for pred')
	...
	parser.add_argument('--deep_layer', default=2, type=int, help='how many deep layers for each encoder')
	parser.add_argument('--gnn_layer', default=2, type=int, help='number of gnn layers')
	parser.add_argument('--data', default='yelp', type=str, help='name of dataset')
	parser.add_argument('--target', default='buy', type=str, help='target behavior to predict on')
	# parser.add_argument('--decay_step', default=1, type=int, help='Epoch number to decay')
